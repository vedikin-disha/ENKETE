          ...
          {/* <Row style={{ marginTop: 10, marginHorizontal: 0 }}>
            ...
            <SelectDropdown
              ...
              renderCustomizedButtonChild={(selectedItem, index) => {
                return (
                  <View style={styles.dropdown3BtnChildStyle}>
                    <Icon name="card-bulleted-outline" color={theme.colors.text} size={32} />
            ...
            <SelectDropdown
              data={structures.map(method => method.stucture_name)} // Map the data to display only assessment method codes
              ...
              renderCustomizedButtonChild={(selectedItem, index) => {
                return (
                  <View style={styles.dropdown3BtnChildStyle}>
                    <Icon name="office-building" color={theme.colors.text} size={32} />
