import { StyleSheet, Image, View, PermissionsAndroid, Modal, TouchableOpacity, TextInput, ScrollView } from 'react-native'
...
<Button
      ...
      <Row style={{ marginVertical: 5 }}>
        <ImageUploadCard
          ...
          onUpload={() => props.onHandleUploadImage('pic_0')}
          imgSrc={props.imageSource['pic_0']["base64"]?`data:`+ props.imageSource['pic_0']["mime"] +`;base64,${props.imageSource['pic_0']["base64"]}`:""}
        />
        <ImageUploadCard
         icon='menu'
          ...
          imgSrc={props.imageSource['pic_1']["base64"]?`data:`+ props.imageSource['pic_1']["mime"] +`;base64,${props.imageSource['pic_1']["base64"]}`:""}
        />
      </Row>
      ...
      <Row style={{ marginVertical: 15 }}>
        <ImageUploadCard
         icon='menu'
          ...
          imgSrc={props.imageSource['pic_2']["base64"]?`data:`+ props.imageSource['pic_2']["mime"] +`;base64,${props.imageSource['pic_2']["base64"]}`:""}
        />
        <ImageUploadCard
         icon='menu'
          ...
          imgSrc={props.imageSource['pic_3']["base64"]?`data:`+ props.imageSource['pic_3']["mime"] +`;base64,${props.imageSource['pic_3']["base64"]}`:""}
        />
      </Row>
